...
int AccStatus = 0;  // 用来描述加速的阶段，静止，0->提速，1->爬升，2->缓冲，3->到达最高速度，4->减速，5->骤降，6->缓冲
// 修改数组大小为8
int SpeedPoint[8] = {0, 300, 200, 100, 50, 100, 200, 300};
...
unsigned int TimeMap[141] = {0,   376, 356, 337, 319, 303, 287, 272, 257, 244, 231, 219, 208, 197, 187, 177, 168, 159,
                             151, 144, 136, 129, 123, 117, 111, 105, 100, 95,  91,  86,  82,  78,  74,  71,  68,  65,
                             62,  59,  56,  54,  51,  49,  47,  45,  43,  41,  39,  38,  36,  35,  34,  32,  31,  30,
                             29,  28,  27,  26,  25,  24,  23,  23,  22,  21,  21,  20,  20,  19,  19,  18,  18,  17,
                             17,  16,  16,  16,  15,  15,  15,  15,  14,  14,  14,  14,  14,  13,  13,  13,  13,  13,
                             13,  12,  12,  12,  12,  12,  12,  12,  12,  12,  11,  11,  11,  11,  11,  11,  11,  11,
                             11,  11,  11,  11,  11,  11,  11,  11,  11,  11,  11,  10,  10,  10,  10,  10,  10,  9,
                             9,   9,   9,   8,   8,   8,   8,   8,   7,   7,   7,   7,   7,   6,   6};
